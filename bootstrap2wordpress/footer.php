...
?>
  ...
  <footer>
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-3">
          <p><a href="/"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/logo.png" alt="Bootstrap to Wordpress"></a></p>
        </div>
        <div class="col-sm-6">
          <nav>
  ...
  <div class="modal fade" id="myModal">
	...
	<script src="<?php echo get_template_directory_uri(); ?>/assets/js/popper-1.14.1.min.js"></script>
